...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -0.60379  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(8, 25)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 0.53799  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(1, 1000)
...
def run_test_count_sines_from():
    ...
    # Test 3:
    expected = 21
    answer = count_sines_from(0, 30)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 6
    answer = count_sines_from(5, 12)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 5:
    expected = 25
    answer = count_sines_vs_cosines(25)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
